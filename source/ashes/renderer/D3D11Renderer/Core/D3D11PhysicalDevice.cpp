...
#	endif
	...
	void PhysicalDevice::doInitialiseProperties()
	{
		...
		//	do not report dx version as vulkan version. reportint 1.0 will be fine
		major = 1;
		minor = 0;
	...
	void PhysicalDevice::doInitialiseFeatures()
	{
		...
		m_features.imageCubeArray = m_adapterInfo.featureLevel >= D3D_FEATURE_LEVEL_10_1;
		m_features.independentBlend = m_adapterInfo.featureLevel >= D3D_FEATURE_LEVEL_9_3;
